...
class ViewController: UIViewController {
    ...
    var playerr = 1
    //  ---------------------------------------------------------------------
    @IBAction func resetButton(_ sender: UIButton) { // to return the game and put background gray color
        button1.backgroundColor = .gray
        button2.backgroundColor = .gray;  button3.backgroundColor = .gray;  button4.backgroundColor = .gray ; button5.backgroundColor = .gray;  button6.backgroundColor = .gray ; button7.backgroundColor = .gray ; button8.backgroundColor = .gray ; button9.backgroundColor = .gray
...
if (button1.backgroundColor == .red) && (button2.backgroundColor == .red) && (button3.backgroundColor == .red){
  ...
  // red won case ---------------------------------------
    ...
    // check who player first person or second person
